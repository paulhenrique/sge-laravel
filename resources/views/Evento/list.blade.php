                        ...
                        <div class="box">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row text-center ">
                                    <a class="col-md-6 col-sm-2  links" href="{{ route('showEvent',['Apelido' => $evento->Apelido]) }}"><img src="{{ asset('images/search.svg') }}" class="img-fluid text-center button list_svg">
                                        <figcaption>Visualizar</figcaption>
                                    </a>
                                    @can("isAdmin")
                                    @if($evento->inscrito == false)
                                    <a class="col-md-6 col-sm-2  links" href="{{ route('inscrever_user_evento',[ 'idEvento' => $evento->idEvento]) }}"><img src="{{ asset('images/checked.svg') }}" class="img-fluid text-center  button list_svg">
                                        <figcaption>Inscrever</figcaption>
                                    </a>
                                    @else
                                    <a class="col-md-6 col-sm-2  links" href="{{ route('desinscrever',[ 'idEvento' => $evento->idEvento]) }}"><img src="{{ asset('images/cancel.svg') }}" class="img-fluid text-center  button list_svg">
                                        <figcaption>Desinscrever</figcaption>
                                    </a>
                                    @endif
