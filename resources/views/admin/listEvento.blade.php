						...
						<img src="{{ url("/storage/{$evento->Logo}") }}" class="img-fluid list_image" alt="logo_do_evento.{{$evento->Nome}}">
							<div class="card-body">
								...
								<div class="row text-center">
									...
									<a class="col-md-4 col-sm-6 col-xl-4 links" href="{{ route('list_atividade_admin', ['idEvento' => $evento->idEvento])}}"><img src="{{ asset('images/workshop.svg') }}" class="img-fluid text-center button list_svg"><figcaption>Atividades</figcaption></a>
